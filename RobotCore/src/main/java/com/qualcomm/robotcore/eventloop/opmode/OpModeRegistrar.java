 ...
 * parameter of type {@link OpModeManager} or {@link AnnotatedOpModeManager}, and that
 * method will be automatically called at the right time to register OpModes. You can
 * use any of the register() methods that exist on the {@link AnnotatedOpModeManager}
